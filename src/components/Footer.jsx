...
function Footer({ darkMode }) {
  const [footerRef, footerAnim] = useScrollAnimation('fade-in-up')

  return (
    <div 
      ref={footerRef}
      className={`animate-on-scroll ${footerAnim} rounded-lg overflow-hidden ${
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div className={`p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow ${
          ...
          <h2 className="text-2xl font-bold mb-4 border-b pb-2">Goals</h2>
        ...
        <div className={`p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow ${
          ...
          <div className="space-y-3">
            ...
            <a 
              href="https://github.com/Wilmer27-ai" 
              target="_blank"
              rel="noopener noreferrer"
              className={`flex items-center gap-2 text-sm hover:text-blue-600 transition ${
                darkMode ? 'text-gray-300' : 'text-gray-700'
